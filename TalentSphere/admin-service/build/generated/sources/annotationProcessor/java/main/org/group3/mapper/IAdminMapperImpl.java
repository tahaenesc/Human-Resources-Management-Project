...
public class IAdminMapperImpl implements IAdminMapper {
    ...
    public FindByIdResponseDto adminToFindByIdResponseDto(Admin admin) {
        ...
        if ( admin.getCreatedDate() != null ) {
            findByIdResponseDto.createdDate( String.valueOf( admin.getCreatedDate() ) );
        }
        if ( admin.getUpdatedDate() != null ) {
            findByIdResponseDto.updatedDate( String.valueOf( admin.getUpdatedDate() ) );
        }
